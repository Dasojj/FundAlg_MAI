#ifndef BORDER_BLOCK_ALLOCATOR_H
#define BORDER_BLOCK_ALLOCATOR_H

#include "logger.h"
#include "allocator.h"

class border_block_allocator : public memory {
public:
...
public:
    border_block_allocator(size_t data_size, allocation_method method, memory* alloc = nullptr, logger *log = nullptr) {
        if(alloc == nullptr) {
